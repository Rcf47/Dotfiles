# Generated by Powerlevel10k configuration wizard on 2024-04-18 at 16:06 +07.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{#a6e3a1}'   # green foreground /catppuccin green
      local   modified='%F{#fab387}'  # yellow foreground /catppuccin orange
      local  untracked='%F{#f5c2e7}'   # blue foreground /catppuccin pink
  ...
  typeset -g POWERLEVEL9K_EXAMPLE_FOREGROUND="#89b4fa"
